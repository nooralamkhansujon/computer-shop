...
<style>
       ...
       body{
            background:url('images/login-header.jpeg')center/cover no-repeat fixed;
       }
...
<body>
 ...
 <div class="login_section">
            <div class="login_body">
                <h2 class="header">Admin Sign Up</h2>
                   <form action="" method="POST">
                          ...
                          <p class="text-light">Don't You have any Account? <small class="font-size-10"><a href="login.php" class="text-info">login</a></small></p>
